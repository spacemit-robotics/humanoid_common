...
2. [`policy_adapter`](src/behavior_manager/policy_adapter/) 负责参考动作读取、时间轴、朝向对齐，以及 ProtoMotions 的输入协议。
...
MJLab 使用 NPZ 参考动作；ProtoMotions 使用预处理后的 CSV，并可追加
`future_steps`。策略若配置
