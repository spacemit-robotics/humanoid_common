...
private:
    void LoadReference() {
        ...
        auto joint_pos = cnpy::npz_load(config_.reference_file, "joint_pos");
        auto joint_vel = cnpy::npz_load(config_.reference_file, "joint_vel");
        auto body_pos = cnpy::npz_load(config_.reference_file, "body_pos_w");
        auto body_quat = cnpy::npz_load(config_.reference_file, "body_quat_w");
